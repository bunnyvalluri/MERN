...
const LANDING_JSON_LD = [
  {
    ...
    description:
      'Discover 2,000+ verified tech internships at top startups and Fortune 500 companies.',
    potentialAction: {
      '@type': 'SearchAction',
      target: {
        '@type': 'EntryPoint',
  ...
  },
  {
    ...
    name: 'InternHub',
    url: 'https://internhub.dev/',
    logo: 'https://internhub.dev/favicon.svg',
    sameAs: ['https://twitter.com/internhubdev'],
  },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col selection:bg-brand-500/20 selection:text-brand-700">
      ...
      <main id="main-content" className="flex-1" aria-label="InternHub homepage">
        ...
        {/* ========================================================================= */}
        <section aria-labelledby="testimonials-heading" className="py-20 sm:py-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            <Badge variant="primary" size="sm">
              Social Proof & Trust
            </Badge>
